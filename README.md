...
- `Dockerfile.openclaw-custom` preinstalls `mcporter`, `codex`, `whisper`, `himalaya`, `bvg`, and `goplaces` so matching built-in skills are not blocked by missing binaries.
